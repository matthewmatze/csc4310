...
void master_node_process(char *argv[],int numtasks, int rank){
   ...
   MPI_Send(&n, 1, MPI_INT, 2, TAG17, MPI_COMM_WORLD);
	MPI_Send(sub2mat1, chunksize, MPI_INT, 2, TAG3, MPI_COMM_WORLD);
   MPI_Send(sub3mat2, chunksize, MPI_INT, 2, TAG4, MPI_COMM_WORLD);
	//Worker 2 m21*m32

   MPI_Send(&n, 1, MPI_INT, 3, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub1mat1, chunksize, MPI_INT, 3, TAG5, MPI_COMM_WORLD);
   MPI_Send(sub2mat2, chunksize, MPI_INT, 3, TAG6, MPI_COMM_WORLD);
	//Worker 3 m11*m22

   MPI_Send(&n, 1, MPI_INT, 4, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub2mat1, chunksize, MPI_INT, 4, TAG7, MPI_COMM_WORLD);
   MPI_Send(sub4mat2, chunksize, MPI_INT, 4, TAG8, MPI_COMM_WORLD);
	//Worker 4 m21*m42

   MPI_Send(&n, 1, MPI_INT, 5, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub3mat1, chunksize, MPI_INT, 5, TAG9, MPI_COMM_WORLD);
   MPI_Send(sub1mat2, chunksize, MPI_INT, 5, TAG10, MPI_COMM_WORLD);
	//Worker 5 m31*m12
		
   MPI_Send(&n, 1, MPI_INT, 6, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub4mat1, chunksize, MPI_INT, 6, TAG11, MPI_COMM_WORLD);
   MPI_Send(sub3mat2, chunksize, MPI_INT, 6, TAG12, MPI_COMM_WORLD);
	//Worker 6 m41*m32
		
   MPI_Send(&n, 1, MPI_INT, 7, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub3mat1, chunksize, MPI_INT, 7, TAG13, MPI_COMM_WORLD);
   MPI_Send(sub2mat2, chunksize, MPI_INT, 7, TAG14, MPI_COMM_WORLD);
	//Worker 7 m31*m22
		
   MPI_Send(&n, 1, MPI_INT, 8, TAG17, MPI_COMM_WORLD);
   MPI_Send(sub4mat1, chunksize, MPI_INT, 8, TAG15, MPI_COMM_WORLD);
   MPI_Send(sub4mat2, chunksize, MPI_INT, 8, TAG16, MPI_COMM_WORLD);
	//Worker 8 m41*m42
...
void worker_node_process(int numtasks, int rank){
	...
	if(rank==2){
		...
		sub3mat2 = (int*) malloc(chunksize*sizeof(int *));
		out2 = (int*) malloc(chunksize*sizeof(int *));
     	MPI_Recv(sub2mat1, chunksize, MPI_INT, 0, TAG3, MPI_COMM_WORLD, &status);
     	MPI_Recv(sub3mat2, chunksize, MPI_INT, 0, TAG4, MPI_COMM_WORLD, &status);
	...
	if(rank==3){
		...
		sub2mat2 = (int*) malloc(chunksize*sizeof(int *));
		out3 = (int*) malloc(chunksize*sizeof(int *));
  	 	MPI_Recv(sub1mat1, chunksize, MPI_INT, 0, TAG5, MPI_COMM_WORLD, &status);
    	MPI_Recv(sub2mat2, chunksize, MPI_INT, 0, TAG6, MPI_COMM_WORLD, &status);
	...
	if(rank==4){
		...
		sub4mat2 = (int*) malloc(chunksize*sizeof(int *));
		out4 = (int*) malloc(chunksize*sizeof(int *));
     	MPI_Recv(sub2mat1, chunksize, MPI_INT, 0, TAG7, MPI_COMM_WORLD, &status);
     	MPI_Recv(sub4mat2, chunksize, MPI_INT, 0, TAG8, MPI_COMM_WORLD, &status);
	...
	if(rank==5){
      MPI_Recv(&n, 1, MPI_INT, 0, TAG17, MPI_COMM_WORLD, &status);
		...
		sub1mat2 = (int*) malloc(chunksize*sizeof(int *));
		out5 = (int*) malloc(chunksize*sizeof(int *));
   	MPI_Recv(sub3mat1, chunksize, MPI_INT, 0, TAG9, MPI_COMM_WORLD, &status);
    	MPI_Recv(sub1mat2, chunksize, MPI_INT, 0, TAG10, MPI_COMM_WORLD, &status);
	...
	if(rank==6){
		...
		sub3mat2 = (int*) malloc(chunksize*sizeof(int *));
		out6 = (int*) malloc(chunksize*sizeof(int *));
     	MPI_Recv(sub4mat1, chunksize, MPI_INT, 0, TAG11, MPI_COMM_WORLD, &status);
     	MPI_Recv(sub3mat2, chunksize, MPI_INT, 0, TAG12, MPI_COMM_WORLD, &status);
	...
	if(rank==7){
		...
		sub2mat2 = (int*) malloc(chunksize*sizeof(int *));
		out7 = (int*) malloc(chunksize*sizeof(int *));
     	MPI_Recv(sub3mat1, chunksize, MPI_INT, 0, TAG13, MPI_COMM_WORLD, &status);
     	MPI_Recv(sub2mat2, chunksize, MPI_INT, 0, TAG14, MPI_COMM_WORLD, &status);
	...
	if(rank==8){
		...
		sub4mat2 = (int*) malloc(chunksize*sizeof(int *));
		out8 = (int*) malloc(chunksize*sizeof(int *));
     	MPI_Recv(sub4mat1, chunksize, MPI_INT, 0, TAG15, MPI_COMM_WORLD, &status);
     	MPI_Recv(sub4mat2, chunksize, MPI_INT, 0, TAG16, MPI_COMM_WORLD, &status);
